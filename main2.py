...
def main(args):
    ...
    log_file = osp.join(output_dir, 'log2.txt')
    ...
    num_features = model.num_features # 128
    x = torch.Tensor(2)


    feamap_factor = {'layer2': 8, 'layer3': 16, 'layer4': 32}
    hei = args.height // feamap_factor[args.final_layer] # 384 // 16 = 24
    wid = args.width // feamap_factor[args.final_layer] # 128 // 16 = 8
    ...
    json_file = osp.join(output_dir, 'results2.json')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--neck', type=int, default=128, # diff1  neck = 512
                        help="number of channels for the final neck layer, default: 128")
    parser.add_argument('--ibn', type=str, choices={'a', 'b', 'none'}, default='metab', help="IBN type. Choose from 'a' or 'b'. Default: 'b'")
    # TLift
    ...
    parser.add_argument('--max_size', type=float, default=0.8, help="maximal size for the random occlusion. default: 0.8")
    # optimizer
