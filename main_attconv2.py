...
from reid.models import restranmap2
from reid.models.transmatcher2 import TransMatcher
...
def main(args):
    ...
    if ibn_type == 'none':
        ibn_type = None
    model = restranmap2.create(args.arch, ibn_type=ibn_type, final_layer=args.final_layer, neck=args.neck,
    ...
    if args.use_transformer:
         split_layer= [p*2 for p in split_layer]
...
if __name__ == '__main__':
    ...
    # model
    parser.add_argument('-a', '--arch', type=str, default='resnet50', choices=restranmap2.names(),
